...
_ENV_ALIASES = {
    ...
    ("external", "gemini_api_key"): "GEMINI_API_KEY",
    ("external", "aiml_api_key"): "AIMLAPI_API_KEY",
...
GEMINI_API_KEY: str = get_val("external", "gemini_api_key", os.getenv("GEMINI_API_KEY", ""))
AIMLAPI_API_KEY: str = get_val("external", "aiml_api_key", os.getenv("AIMLAPI_API_KEY", ""))
GOOGLE_API_KEY: str = get_val(
    "external",
    "google_api_key",
