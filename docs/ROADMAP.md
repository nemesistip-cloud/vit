# VIT Blockchain Strategic Roadmap
...
- [ ] Marketplace integration for events-based e-commerce.
- [ ] Cross-border remittance rails via $VIT.
- [ ] OPay/PalmPay/MoMo deep integration.
