...
- [Admin router prefix](admin-router-prefix.md) — admin router registered with prefix="/api" in main.py; all routes are /api/admin/... not /admin/...; verify with /openapi.json not assumptions.
