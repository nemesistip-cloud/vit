...
def upgrade() -> None:
    ...
    if not insp.has_table("identity_organization_members"):
        op.create_table(
            "identity_organization_members",
    ...
    if not insp.has_table("identity_team_members") and insp.has_table("identity_teams"):
        op.create_table(
            "identity_team_members",
            sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    if insp.has_table("identity_team_members"):
    ...
    if insp.has_table("identity_organization_members"):
