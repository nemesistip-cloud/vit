...
class PredictionResponse(BaseModel):
    ...
    # v5.x — explicit submitted market metadata
    submitted_market_id: Optional[str] = None
    submitted_market_side: Optional[str] = None
    submitted_stake: Optional[float] = None
