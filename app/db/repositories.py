...
def _now() -> datetime:
    ...
    ensures the value carries tzinfo so comparisons with tz-aware DB columns
    work correctly on both SQLite (text storage) and PostgreSQL (TIMESTAMPTZ).
    """
