...
async def injury_analysis(body: InjuryAnalysisRequest, _user=Depends(verify_api_key)):
    return {"adjusted_home_prob": 0.33, "adjusted_draw_prob": 0.34, "adjusted_away_prob": 0.33, "impact_severity": "low", "key_absences": [], "narrative": "Native analysis complete."}
...
async def governance_analysis(body: Any, _user=Depends(verify_api_key)): return {"recommendation": "neutral"}
