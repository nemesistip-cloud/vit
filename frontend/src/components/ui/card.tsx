...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-sm border border-white/5 bg-white/[0.01] text-card-foreground shadow-sm transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-sm font-bold uppercase tracking-[0.1em] leading-none text-foreground",
      className
    )}
    {...props}
  />
