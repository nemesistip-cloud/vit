  ...
  const groups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { label: "Value Analytics", icon: BarChart2, href: "/value-analytics" },
        { label: "Accumulator", icon: Layers, href: "/accumulator" },
        { label: "Odds Intel", icon: TrendingUp, href: "/odds" },
        { label: "Backtest", icon: FlaskConical, href: "/backtest" },
        { label: "Bankroll", icon: Landmark, href: "/bankroll" },
      ]
    },
    {
      name: "Earn",
      items: [
        ...
        { label: "Tasks", icon: Target, href: "/tasks" },
        { label: "Merit", icon: Medal, href: "/merit" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Training", icon: Brain, href: "/training" },
        { label: "Model Performance", icon: LineChart, href: "/model-performance" },
        { label: "Marketplace", icon: ShoppingBag, href: "/marketplace" },
        { label: "Validators", icon: ShieldCheck, href: "/validators" },
      ]
    },
    {
      name: "Network",
      items: [
        { label: "Node Network", icon: Network, href: "/network" },
        { label: "Smart Contracts", icon: FileCode2, href: "/smart-contracts" },
        { label: "Treasury", icon: Vault, href: "/treasury" },
    ...
    },
    {
      name: "You",
      items: [
        { label: "Identity", icon: Fingerprint, href: "/identity" },
        { label: "KYC Verify", icon: BadgeCheck, href: "/kyc" },
        { label: "Subscription", icon: Zap, href: "/subscription" },
    ...
    <div className="space-y-6">
      {groups.map((group) => (
        <div key={group.name} className="space-y-2">
          <h3 className="px-3 text-[10px] font-bold font-mono text-muted-foreground uppercase tracking-widest">
            {group.name}
          </h3>
            ...
            {group.items.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href}>
                  <a className={`flex items-center gap-3 px-3 py-1.5 rounded-lg text-[11px] transition-colors ${
