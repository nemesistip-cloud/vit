...
const connectors = [
  ...
  coinbaseWallet({
    appName: "VIT",
    appLogoUrl: "https://vit.network/logo.png",
  }),
  ...(wcProjectId
    ? [
        walletConnect({
          ...
          metadata: {
            ...
            description: "To build intelligent systems where value, trust, and merit become programmable.",
            url: "https://vit.network",
            icons: ["https://vit.network/logo.png"],
          },
        }),
      ]
    : []),
