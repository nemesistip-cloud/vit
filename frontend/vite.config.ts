...
export default defineConfig(({ command }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      // registerSW.js is generated by the production build. Injecting its
      // script tag in dev makes Vite serve the SPA HTML at that URL, which
      // browsers correctly reject as a JavaScript MIME type.
      injectRegister: command === 'build' ? 'script' : null,
