...
export default defineConfig({
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          "vendor-web3":     ["viem", "wagmi", "@wagmi/connectors"],
  ...
  server: {
    ...
    proxy: {
      ...
      "/referral": { target: "http://localhost:8000", bypass: htmlBypass },
      "/identity": { target: "http://localhost:8000", bypass: htmlBypass },
      "/kyc": { target: "http://localhost:8000", bypass: htmlBypass },
      "/did": { target: "http://localhost:8000", bypass: htmlBypass },
      "/network": { target: "http://localhost:8000", bypass: htmlBypass },
      "/leaderboard": { target: "http://localhost:8000", bypass: htmlBypass },
      "/rewards": { target: "http://localhost:8000", bypass: htmlBypass },
      "/postbacks": { target: "http://localhost:8000", bypass: htmlBypass },
      "/merit": { target: "http://localhost:8000", bypass: htmlBypass },
      "/tasks": { target: "http://localhost:8000", bypass: htmlBypass },
